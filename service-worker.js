...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('./service-worker.js',{scope : '/PWD/'}).then(function(registration) {
...
var filesToCache = [
  ...
  './images/service-worker-1.png','./images/service-worker-2.png','./images/service-worker-3.png', './images/sw-lifecycle.png',
];
